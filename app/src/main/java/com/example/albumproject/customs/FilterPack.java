//package com.example.albumproject.customs;
//
//import android.content.Context;
//
//import com.example.albumproject.data.Filter;
//
//import java.util.ArrayList;
//import java.util.List;
//import com.example.albumproject.R;
//import com.example.albumproject.data.SubFilter;
...
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(rgbKnots, null, null, null));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, redKnots, null, null));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(30));
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1f));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(rgbKnots, redKnots, greenKnots, blueKnots));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, null, null, blueKnots));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.5f));
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(rgbKnots, redKnots, greenKnots, blueKnots));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.2f));
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, null, null, blueKnots));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new SaturationSubfilter(-100f));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new SaturationSubfilter(-100f));
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.3f));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(20));
//        return filter;
//    }
//
//    public static Filter getMetropolis(Context context) {
//        Filter filter = new Filter(context.getString(R.string.metropolis));
//        filter.addSubFilter((SubFilter) new SaturationSubfilter(-1f));
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.7f));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(70));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.9f));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(60));
//        filter.addSubFilter((SubFilter) new VignetteSubfilter(context, 200));
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, redKnots, null, blueKnots));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.5f));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(10));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.5f));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(5));
//        filter.addSubFilter((SubFilter) new VignetteSubfilter(context, 150));
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, redKnots, null, blueKnots));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(60));
//        filter.addSubFilter((SubFilter) new VignetteSubfilter(context, 200));
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, null, greenKnots, null));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(30));
//        filter.addSubFilter((SubFilter) new SaturationSubfilter(0.8f));
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.3f));
//        filter.addSubFilter((SubFilter) new VignetteSubfilter(context, 100));
//        filter.addSubFilter((SubFilter) new ColorOverlaySubFilter(100, .2f, .2f, .1f));
//        return filter;
//    }
//
...
//        filter.addSubFilter((SubFilter) new ContrastSubFilter(1.5f));
//        filter.addSubFilter((SubFilter) new BrightnessSubFilter(-10));
//        filter.addSubFilter((SubFilter) new ToneCurveSubFilter(null, redKnots, greenKnots, blueKnots));
//        return filter;
//    }
//}